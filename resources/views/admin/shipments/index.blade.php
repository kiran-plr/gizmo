                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="float-right mb-3 button-flex">
                                <a href="{{ route('admin.shipment.export') }}" class="btn btn-primary">
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                        ...
                                                        @if ($shipment->status == 'pending')
                                                            <form
                                                                action="{{ route('admin.shipment.cancel', $shipment->id) }}"
                                                                method="POST">
                                                                @csrf
                                                                <a class="dropdown-item cancel" href="javascript:;">Cancel</a>
                                                            </form>
                                                        @endif
                                                    </div>
                                                </div>
