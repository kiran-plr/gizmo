            ...
            <div class="dropdown d-inline-block">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    <a class="dropdown-item" href="{{ route('user.dashboard') }}">
                        <i class="fas fa-home font-size-16 align-middle me-1"></i>
                        <span key="t-dashboard">{{ __('Dashboard') }}</span>
                    </a>
                    <a class="dropdown-item" href="{{ route('user.password.change.index') }}">
                        <i class="fas fa-key font-size-16 align-middle me-1"></i>
                        <span key="t-change-password">{{ __('Change Password') }}</span>
                    </a>
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item text-danger"
                        href="{{ auth()->guard('user')->check() &&auth()->guard('user')->user()->role->slug == 'user'? route('user.user.logout'): route('logout') }}">
